...
<form class="form-horizontal" id="addForm" role="form" data-toggle="validator" method="post" action="/admin/save" enctype="multipart/form-data">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <img src="/static/upload/<?php echo $this->task->image; ?>" border="0" alt="">
    </div>
  </div>   
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label class="control-label">
          <input type="checkbox" name="status" value="1" <?php if ($this->task->status == \Model\Task::STATUS_FINISHED) { echo ' checked="checked"'; } ?>> <strong>Task is finished</strong>
        </label>
      </div>
    </div>
  </div>  
